...
// Score'y jako z.number(): structured output Anthropica odrzuca minimum/maximum na integer,
// więc zakres 1-10 wymuszamy opisem pola i promptem.
...
// target: "draft-07" zapewnia zgodność z Claude Agent SDK outputFormat
